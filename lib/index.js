...
const Popover = createClass({
  ...
  resolvePopoverLayout () {
    ...
    const scrollSize = Layout.El.calcScrollSize(this.props.frameEl)
  ...
  trackPopover () {
    ...
    // this.props.frameEl = this.props.frameEl
    ...
    resizeEvent.on(this.props.frameEl, this.onFrameResize)
  ...
  untrackPopover () {
    ...
    resizeEvent.off(this.props.frameEl, this.onFrameResize)
  ...
  measureFrameBounds () {
    this.frameBounds = Layout.El.calcBounds(this.props.frameEl)
  },
  renderLayer () {
    ...
    return (
      E.div(popoverProps,
        E.div({ className: `Popover-body`, onMouseEnter: (ev) => this.props.onMouseEnter(ev), onMouseLeave: (ev) => this.props.onMouseLeave(ev)}, ...popoverBody),

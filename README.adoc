...
**This fork differs from the original in that it lets you specify a frame element other than the window. See the link:https://mhgbrown.github.io/react-popover/build/frame.html[demo].**
...
* link:https://mhgbrown.github.io/react-popover/build/playground.html[Playground]
* link:https://mhgbrown.github.io/react-popover/build/rows.html[Rows]
* link:https://mhgbrown.github.io/react-popover/build/jsx.html[Using JSX]
* link:https://mhgbrown.github.io/react-popover/build/frame.html[frameEl]
...
##### `frameEl :: DOMElement | Null`
The element within which the popover should orient itself. Defaults to `window`.
